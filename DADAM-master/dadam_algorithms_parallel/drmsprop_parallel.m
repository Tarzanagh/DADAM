function [w, infos] = drmsprop_parallel(problem, in_options)
%Decentralized RMSPROP algorithm.
...
if options.verbose > 0
    fprintf('DRMSPROP-%s: Epoch = %03d, cost = %.16e, optgap = %.4e\n', options.sub_mode, epoch, f_val, optgap);
end
