function [w, infos] = cdsgd(problem, in_options)
% Corrected Decentralized SGD algorithm.
%
...
for ii=1:num_nod
    grad_val_EX(:,ii)= problem.grad(w_ex_node(:,ii),indice_node{ii});
end
...
if options.verbose > 0
    fprintf('C-DSGD: Epoch = %03d, cost = %.16e, optgap = %.4e\n', epoch, f_val, optgap);
end
