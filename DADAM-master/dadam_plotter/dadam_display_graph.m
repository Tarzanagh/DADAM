function dadam_display_graph(x_category, y_category, algorithm_list, w_list, info_list, scale, line, width)
...
%
% Created by H.Kasai on Oct. 23, 2016. See, https://github.com/hiroyuki-kasai/SGDLibrary
% Modified by D.Ataee Tarzanagh on Jan. 17, 2019.
    ...
    if strcmp(line_type, 'line')
        linetype = {'r','b','c','g','m','r--','b--','c--','g--','m--','r:','b:','c:','g:','m:','y:','r.','b.','c.','g.','m.','y.'};
